...
document.getElementById("blobForm").addEventListener("submit", async function(event) {
    ...
    const formattedStateDiffs = JSON.stringify(JSON.parse(state_diffs), null, 2);

    document.getElementById("stateDiffsOutput").textContent = formattedStateDiffs;
});
